...
define(
    function (require) {
        ...
        transit.to = function (elem, properties, duration, easing, callback) {
            var transitObj = new TransitObject(elem);
            transitObj.transition(properties, duration, easing, callback);
        };
        ...
        TransitObject.prototype.loop = function (times) {
            var me = this;
            var run = function () {
                me.reverse().transition.apply(me, me.lastTransition);
            };
            for (;times > 1; times--) {
                me._deferredRun(run);
            }
         ...
         * @return {Object} this
         */
        TransitObject.prototype.transition = function (properties, duration, easing, callback, type) {
            var element = this.elem;
            var delay = 0;
        ...
        TransitObject.prototype.then = TransitObject.prototype.transition;
